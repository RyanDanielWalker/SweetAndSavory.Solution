...
namespace SweetAndSavory.Migrations
{
    ...
    [Migration("20210604162935_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SweetAndSavory.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SweetAndSavory.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SweetAndSavory.Models.Flavor", b =>
                {
                    b.HasOne("SweetAndSavory.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
